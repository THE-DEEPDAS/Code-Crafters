						...
						{[
							{
								icon: Mail,
								title: "Email Us",
								lines: ["deepdblm@outlook.com", "u23ai052@coed.svnit.ac.in"],
							},
							{
								icon: Phone,
								title: "Call Us",
								lines: ["+91 99740 19394", "Mon-Fri: 9:00 AM - 6:00 PM"],
							},
							{
								icon: MapPin,
								title: "Visit Us",
					...
					<div className='glass-effect rounded-lg shadow-lg p-12 mb-16 transform hover:scale-[1.02] transition-all duration-500'>
						...
						<div className='max-w-3xl mx-auto'>
							<p className='text-gray-700 mb-12 text-center leading-relaxed text-lg'>
								...
								achieve their full potential. Our dedication to excellence,
							...
							<div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
								{[
									...
									>
										...
										<h3 className='text-lg font-semibold mb-2 mt-4 gradient-text'>
											{item.title}
										</h3>
							...
							{[
								{
									...
									image: deep,
									description:
										"Deep is an expert in artificial intelligence and machine learning, with a passion for solving complex problems.",
									Icon: Code,
								},
								{
									name: "Kuruv Patel",
									...
									image: kuruv,
									description:
										"Kuruv specializes in building scalable backend systems and has architected solutions for Fortune 500 companies.",
									Icon: Palette,
								},
								{
									name: "Hitarth Shah",
									...
									image: hitarth,
									description:
										"Hitarth the ultimate Frontend guy you may imagine.",
									Icon: Database,
								},
							].map((member, index) => (
